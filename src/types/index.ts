export interface Item {
  ...
  description?: string; stock: number; created_at: string; updated_at: string;
}
export interface OrderItem {
  id: number; order_id: number; item_id: number | null; item_name: string;
...
export interface Summary {
  totalRevenue: number; todayRevenue: number; totalOrders: number;
  todayOrders: number; totalItems: number; pendingOrders: number;
}
